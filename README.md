...
- **10 pre-bundled tafsir editions** — 8 Arabic (*Al-Muyassar, Al-Jalalayn, Al-Qurtubi, Tanweer Al-Miqbas, Al-Waseet, Al-Baghawi, Ibn Kathir, Saadi*) and 2 Pure English (*Tafsir Ibn Kathir, Tafheem-ul-Quran* by Maududi) — 100% pre-bundled offline in app assets and SQLite
...
- **Interactive Tajweed rules engine** — live color-coded pronunciation highlighting (Ghunnah, Qalqalah, Ikhfa, Idgham, Madd) with toggle switch
- **Hifz memorization mode** — frosted glass Gaussian blur verse masking for self-testing in card & continuous mushaf views
- **Share as styled image card** — export horizontal landscape cards with Material 3 themes, customizable Black Frame padding sliders (0px – 36px), and gold verse markers
...
- **Bilingual & theme-adaptive** — automatically adapts to English/Arabic and Light/Dark Material 3 themes
- **1-line 5-prayer layout** — all 5 daily prayers (Fajr, Dhuhr, Asr, Maghrib, Isha) rendered on a single horizontal row
- **Frozen-free countdown** — battery-friendly HH:MM countdown with dynamic active prayer highlighting
