...
class AyaCombinedWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            // Next prayer info
            val nextPrayerName = prefs.getString("flutter.widget_next_prayer_name", "") ?: ""
            val nextPrayerEpoch = prefs.getLong("flutter.widget_next_prayer_epoch", 0L)
            val activePrayer = prefs.getString("flutter.widget_active_prayer", "") ?: ""

            // Set app name
            views.setTextViewText(R.id.widget_title, appName)

            // Compute live countdown from epoch
