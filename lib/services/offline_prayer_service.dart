...
class OfflinePrayerService {
  ...
  static Future<PrayerTimeData> getPrayerTimes({
    ...
    switch (method) {
      case 0: params = CalculationMethod.shia_ithna_ashari.getParameters(); break;
      case 1: params = CalculationMethod.karachi.getParameters(); break;
      case 2: params = CalculationMethod.north_america.getParameters(); break;
      case 3: params = CalculationMethod.muslim_world_league.getParameters(); break;
      case 4: params = CalculationMethod.umm_al_qura.getParameters(); break;
      case 5: params = CalculationMethod.egyptian.getParameters(); break;
      case 7: params = CalculationMethod.tehran.getParameters(); break;
      case 8: params = CalculationMethod.dubai.getParameters(); break;
      case 9: params = CalculationMethod.kuwait.getParameters(); break;
      case 10: params = CalculationMethod.qatar.getParameters(); break;
      case 11: params = CalculationMethod.singapore.getParameters(); break;
      case 12: params = CalculationMethod.turkey.getParameters(); break;
      case 13: params = CalculationMethod.morocco.getParameters(); break;
      default: params = CalculationMethod.other.getParameters(); break;
    }
    ...
    return PrayerTimeData(
      ...
      imsak: _formatTime(prayerTimes.fajr.subtract(const Duration(minutes: 10))),
