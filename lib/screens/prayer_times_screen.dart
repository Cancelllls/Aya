              ...
              ? () {
                  showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      content: Text(eventTitle, style: TextStyle(fontSize: 18)),
                      actions: [
                        TextButton(
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
                IconButton(
                  icon: Icon(Icons.chevron_left, color: Color(0xFFE5C158)),
                ...
                IconButton(
                  icon: Icon(Icons.chevron_right, color: Color(0xFFE5C158)),
