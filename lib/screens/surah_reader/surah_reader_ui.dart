                ...
                GestureDetector(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      // Ayah Arabic Text with Hifz Gaussian Blur Filter
                      GestureDetector(
                        onTap: () {
                          if (_isHifzMode) {
                        ...
                        child: ImageFiltered(
                          imageFilter: ImageFilter.blur(
                            sigmaX: (_isHifzMode && !_unmaskedAyahs.contains(ayah.numberInSurah))
                                ? 7.5
                                : 0.0,
                            sigmaY: (_isHifzMode && !_unmaskedAyahs.contains(ayah.numberInSurah))
                                ? 7.5
                                : 0.0,
                          ),
                          child: Align(
